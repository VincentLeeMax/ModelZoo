...
__all__ = ['resnext18', 'resnext34', 'resnext50', 'resnext101',
           'resnext152']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, num_group=32):
        ...
        self.conv1 = nn.Conv2d(inplanes, planes*2, kernel_size=3, stride=stride, padding=1, bias=False, group=num_group)
        self.bn1 = nn.BatchNorm2d(planes*2)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(planes*2, planes*2, kernel_size=3, stride=stride, padding=1, bias=False, group=num_group)
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10000, num_group=32):
        self.inplanes = 64
